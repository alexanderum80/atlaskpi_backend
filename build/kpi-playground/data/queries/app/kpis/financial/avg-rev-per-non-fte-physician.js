...
var AvgRevenueByFTNonPhysician = (function (_super) {
    __extends(AvgRevenueByFTNonPhysician, _super);
    function AvgRevenueByFTNonPhysician(sales) {
        return _super.call(this, sales, aggregate) || this;
    }
    AvgRevenueByFTNonPhysician.prototype.getData = function (dateRange, frequency) {
        var _this = this;
        var that = this;
    ...
    AvgRevenueByFTNonPhysician.prototype._toSeries = function (rawData) {
        return [{
                name: 'Avg',
    ...
    return AvgRevenueByFTNonPhysician;
}(kpi_base_1.KpiBase));
exports.AvgRevenueByFTNonPhysician = AvgRevenueByFTNonPhysician;
//# sourceMappingURL=avg-rev-per-non-fte-physician.js.map