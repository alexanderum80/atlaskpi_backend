"use strict";
var google_sheet_processor_1 = require("./google-sheet.processor");
/**
 * Google Credentials
 *
...
function importSpreadSheet() {
    ...
    fs.readFile(__dirname + '/client_secret.json', function processClientSecrets(err, content) {
        ...
        // Google Sheets API.
        authorize(JSON.parse(content.toString()), google_sheet_processor_1.importData);
    });
}
exports.importSpreadSheet = importSpreadSheet;
/**
